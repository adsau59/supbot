...
public class Bot {
    ...
    static void CreateBot(WebDriver webDriver, ActionManager actionManager, Checker checker, FeatureManager featureManager, ChatProcessorManager chatProcessorManager, Console console, ChatGroupsManager chatGroupsManager, Looper looper, DatabaseManager databaseManager, Configuration configuration, RemoteActionCall remoteActionCall) {
        me = new Bot();
