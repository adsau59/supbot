...
public class Checker {
    ...
    /**
     * Adds a checker action that that is returned after a timeout time,
     * used to add temporary checker,
     * used to add checker which are indented for one time action, or for limited time.
     *
     * @param checkerAction action to be added.
     * @param timeOutMs timeout time in milli seconds.
     * @param removeCheckerOnSuccess if true, checker is removed after action returns true.
     * @param callback callback called after the checker is removed.
     */
    ...
    /**
     * interface used for checkerWithTimeout callback
     */
