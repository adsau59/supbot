...
public class Looper {
     ...
     *
     * @param profileUrl chrome profile url, if you dont want to use, simple pass empty string
     */
    public Looper(ExtraLooperFunctions extraLooperFunctions, String profileUrl) {
        ...
        if(!profileUrl.isEmpty()) {
            ...
            options.addArguments("user-data-dir="+profileUrl);
